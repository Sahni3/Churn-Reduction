...
train_actual = read.csv("E:/DataScienceEdwisor/Rscripts/Train_data.csv", header = T, na.strings = c(" "," ", "NA"))
test_actual  = read.csv("E:/DataScienceEdwisor/Rscripts/Test_data.csv",header = T, na.strings = c(" ", " ","NA"))
